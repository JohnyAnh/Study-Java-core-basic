...
public class TuDien {
	private Map<String, String> duLieu = new TreeMap<String, String>();// TreeMap Tự sắp xếp
//	private Map<String, String> duLieu = new HashMap<String, String>();// HashMap không sắp xếp
